...
if page == "Pocession Analysis":
    ...
    pocession_df = load_data(pocession_file_path, skip_first_row=True)
    player_df = load_data(player_file_path, skip_first_row=True)
    ...
    # Load data from file
    data_df = pd.read_excel(league_table_file_path, sheet_name='Data')
